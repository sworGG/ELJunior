...
class ItportScheduleRepository @Inject constructor(
    ...
    suspend fun getScheduleForDate(groupId: Int, date: String): Result<List<ScheduleDay>> {
        return getScheduleForWeek(groupId, date)
    }

    suspend fun getScheduleForWeek(groupId: Int, date: String): Result<List<ScheduleDay>> {
